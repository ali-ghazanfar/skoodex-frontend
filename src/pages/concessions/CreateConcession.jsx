...
import { concessionSchema } from '../../validations/concessionSchema';
import { statusOptions, applicableToOptions } from '../../constants/constants';
...
const CreateConcession = () => {
  ...
  } = useFormValidation(concessionSchema);

  const onSubmit = (data) => {
    console.log('Concession data:', data);
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4 pt-4">
            ...
            <Button type="submit" disabled={isSubmitting} className="w-full">
              {isSubmitting ? 'Creating...' : 'Create Concession'}
            </Button>
          </div>
        </form>
      </div>
