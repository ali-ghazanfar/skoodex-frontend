...
import { statusOptions, allowanceTypeOptions, allowancesData } from '../../constants/constants';
...
const Allowances = () => {
  ...
  const handleDeleteConfirm = () => {
    if (selectedAllowance) {
      ...
      console.log('Deleting allowance:', selectedAllowance.id);
  ...
  const filteredData = useMemo(() => {
    return allowancesData.filter((item) => {
