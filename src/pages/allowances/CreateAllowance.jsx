...
import { allowanceSchema } from '../../validations/allowanceSchema';
import { statusOptions, allowanceTypeOptions } from '../../constants/constants';
...
const CreateAllowance = () => {
  ...
  } = useFormValidation(allowanceSchema);
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4 pt-4">
            ...
            <Button type="submit" disabled={isSubmitting} className="w-full">
              {isSubmitting ? 'Creating...' : 'Create Allowance'}
            </Button>
          </div>
        </form>
      </div>
